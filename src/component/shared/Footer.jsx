    ...
    return (
      <footer className="bg-gray-900 text-white pt-8 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          {/* Brand */}
          <div>
            <h2 className="text-2xl font-bold mb-3">DK-GADGET</h2>
          ...
          <div>
            ...
            <ul className="text-sm text-gray-300 space-y-2">
              <li>Email: support@dkgadget.com</li>
              <li>Phone: +880 1884282166</li>
        ...
        <div className="border-t border-gray-700 mt-10 pt-6 text-center text-sm text-gray-400">
         developed by <span className="via-purple-700">Shanto Deb</span>
        </div>
      </footer>
    );
  };
