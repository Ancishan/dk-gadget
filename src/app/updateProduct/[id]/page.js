...
const UpdateProductPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const res = await axios.get(`https://dk-gadget-server-2.onrender.com/products/${id}`);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`https://dk-gadget-server-2.onrender.com/api/products/${id}`, formData);
